...
const AudioButton = () => {
  ...
  useEffect(() => {
    // Escape filename to handle spaces safely
    const bgmUrl =
      "/audio/Frieren_ Beyond Journeys End Season 2 Opening  Mrs. GREEN APPLE - lulu. (Instrumental).mp3";
    bgmRef.current = new Audio(bgmUrl);
    bgmRef.current.loop = true;
    bgmRef.current.volume = 0.1; // Set comfortable background volume
  ...
  return (
    ...
    >
      {isMuted ? (
        // Mute Icon (Pixelated style approximation)
